...
export default function Header() {
  ...
  return (
    <header className="bg-kts-lime sticky top-0 z-50 shadow-md">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-kts-lime border-t-2 border-kts-blue">
          <div className="px-4 py-4 space-y-4 text-kts-blue font-semibold">
            ...
            <button className="w-full px-6 py-2 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition-colors">
              Get a Quote
            </button>
          </div>
        </div>
